...
const Button = ({text,path}) => {
  return (
    <div onClick={()=>Router.push(`${path}`)} className='flex relative flex-col group justify-center hover:drop-shadow-md lighter cursor-pointer items-center w-[10rem] h-14'>
