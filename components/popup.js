    ...
    return (
        <div>
            ...
            <div className={`w-screen h-screen fixed tracking-wider z-50 backdrop-blur-sm text-gray-darker bg-transparent justify-center items-center ${popup ? "flex" : "hidden"}`}>
                <div className='bg-white relative p-[5rem] flex flex-col drop-shadow-xl gap-[2rem] w-[35rem] text-center  justify-center items-center'>
                    ...
                    <div className="flex items-center">
                        <input onClick={() => setshow(true)} id="link-checkbox" type="checkbox" value="" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" />
                        <label htmlFor="link-checkbox" className="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Don&apos;t show this popup again .</label>
                    </div>
