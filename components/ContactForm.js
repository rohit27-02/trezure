...
const ContactForm = () => {
    return (
        <div className='relative overflow-hidden h-[35rem] md:h-[40rem]'>
            ...
            <div>
                <h1 className='md:text-4xl text-xl medium'>Your Information</h1>
                ...
                <button className='md:text-lg px-[1rem] my-[1rem] py-[0.5rem] border hover:bg-brown-light hover:drop-shadow-xl hover:border-gray-darker transition-all duration-200 w-fit'>DOWNLOAD BROCHURE</button>
            </div>
            </Fade>
        </div>
    )
